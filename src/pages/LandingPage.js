...
const LandingPage = (props) => {
  return (
    <div className="landingContainer w-5/6 flex flex-col justify-start items-center bg-darkBlue my-4 mx-32 opacity-90 rounded-xl shadow-8xl xl:my-16">
      ...
      <div className="landingImageDiv border-2 border-lightPink rounded-full w-3/6 overflow-hidden">
